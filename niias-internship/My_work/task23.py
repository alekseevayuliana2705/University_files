...
plt.plot(df2['date'], df2['delayed_less_1h_pct'], label='<1 часа', color='#2ecc71', linewidth=2)
plt.plot(df2['date'], df2['delayed_1_3h_pct'], label='1-3 часа', color='#f39c12', linewidth=2)
plt.plot(df2['date'], df2['delayed_over_3h_pct'], label='>3 часов', color='#e74c3c', linewidth=2)
