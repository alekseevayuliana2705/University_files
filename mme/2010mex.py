...
dom_rows = df_2010[df_2010.iloc[:, 1].str.startswith('DOM_')]
...
output_row = df_2010[df_2010.iloc[:, 1] == 'OUTPUT']
...
# Сохраняем результат
output_file = os.path.join(downloads_path, "Матрица_Леонтьева_Мексика_2010.csv")
