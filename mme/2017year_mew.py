...
file_path = os.path.join(downloads_path, "Мексика 2016-2018 - Лист1-3.csv")

# Загрузка данных
df = pd.read_csv(file_path, encoding='utf-8')

# Фильтрация данных за 2017 год
...
dom_rows = df_2017[df_2017.iloc[:, 1].str.startswith('DOM_')]
...
output_row = df_2017[df_2017.iloc[:, 1] == 'OUTPUT']
...
# Сохраняем результат
output_file = os.path.join(downloads_path, "Матрица_Леонтьева_Мексика_2017.csv")
