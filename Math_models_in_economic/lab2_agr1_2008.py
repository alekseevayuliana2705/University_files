...
# Вектор валового выпуска для 2008 года
...
file_path = "~/Downloads/Матрица_Леонтьева_Мексика_2008.csv"
df = pd.read_csv(file_path, index_col=0)

codes = df.index.tolist()
A = df.values

# Находим пересечение отраслей между двумя файлами
...
output_file = "~/Downloads/Агрегированная_матрица_Леонтьева_Мексика_2008.csv"
