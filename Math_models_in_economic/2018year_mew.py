...
dom_rows = df_2018[df_2018.iloc[:, 1].str.startswith('DOM_')]
...
output_row = df_2018[df_2018.iloc[:, 1] == 'OUTPUT']
...
# Сохраняем результат
output_file = os.path.join(downloads_path, "Матрица_Леонтьева_Мексика_2018.csv")
