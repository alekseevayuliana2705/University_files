...
# Только DOM_ строки (внутреннее производство)
dom_rows = df_2008[df_2008.iloc[:, 1].str.startswith('DOM_')]
...
output_row = df_2008[df_2008.iloc[:, 1] == 'OUTPUT']
...
# Сохраняем результат
output_file = os.path.join(downloads_path, "Матрица_Леонтьева_Мексика_2008.csv")
